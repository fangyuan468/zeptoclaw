...
use super::format::{
    ...
    prettify_tool_arguments, resolve_streamed_response_text,
};
use super::inbound::{inbound_to_message, resolve_images_to_base64};
use super::loop_events::{
    is_streaming_capable, publish_tool_call_finished_event, publish_tool_call_started_event,
    supports_custom_ui_channel, ThinkingScope, ToolCallOutcome,
};
use super::tool_helpers::{
    check_loop_guard, check_loop_guard_outcomes, is_trusted_local_session,
    needs_sequential_execution, propagate_routing_metadata, resolve_tool_approval,
    resolve_tool_call_name, sync_trimmed_tool_results, ApprovalHandler,
};
...
mod tests {
    use super::*;
    use super::super::file_artifact::{FileArtifactCandidate, FileArtifactOperation};
    use super::super::inbound::MAX_TEXT_DOCUMENT_SIZE;
